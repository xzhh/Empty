...
int Configurations::getCapacity() { return maxConfigs; }

int Configurations::getSize() { return configurations.size(); }

ConfigurationList Configurations::all() { return configurations; }
...
ConfigurationPtr Configurations::back() { return configurations.back(); }
...
void Configurations::gather()
{
    ...
    {
        ConfigurationPtr config = std::make_shared<Configuration>(gatherPos, gatherVel, gatherForce,
                                                                  gatherRadius);  // totalN
...
void Configurations::registerPython()
{
    ...
    class_<Configurations>("analysis_Configurations", init<std::shared_ptr<System> >())
