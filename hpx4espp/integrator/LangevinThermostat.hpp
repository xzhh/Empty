...
public:
    LangevinThermostat(shared_ptr<SystemHPX> system, shared_ptr<StorageHPX> storage);
...
public:
    ...
    shared_ptr<espressopp::esutil::RNG> rng;  //!< random number generator used for friction term

    shared_ptr<hpx4espp::esutil::RNGThread> rngThread;
};
}  // namespace integrator
}  // namespace hpx4espp
}  // namespace espressopp
