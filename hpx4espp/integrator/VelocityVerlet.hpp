...
namespace espressopp::hpx4espp::integrator
{
...
protected:
    ...
    json before_update_ghosts;
    json after_update_ghosts;


    json before_collect_forces;
    json after_collect_forces;
...
public:
    ...
    //--------------------------------------------------------//
    void log_to_json(espressopp::storage::Storage& storage,
