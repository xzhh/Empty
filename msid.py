...
nodeGrid = espressopp.tools.decomp.nodeGrid(n=comm.size,box_size=None,rc=rc,skin=skin)
...
print("nodeGrid1           = ", nodeGrid)
print("cellGrid1           = ", system.storage.getCellGrid())
system.storage.cellAdjust(shear=True)
print("nodeGrid2           = ", nodeGrid)
print("cellGrid2           = ", system.storage.getCellGrid())
sys.exit(0)
