...
rho                = 0.844
# shear rate
shear_rate         = 0.5 # set 2.0 = a top/bot particle shears by a length of box_L every unit time (ps)
gamma_coef = 1.0
...
#DPD
thermostat=espressopp.integrator.DPDThermostat(system, verletlist)
thermostat.gamma=5.0
