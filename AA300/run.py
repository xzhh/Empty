...
if not USE_EWALD:  #truncated coulomb
    ...
    qq_interactions=gromacs.setCoulombInteractions(system, vl, rc, types, epsilon1=1, epsilon2=13, kappa=0) #for CG epsilon2=17.5, for atomistics 13 and for water 80
else:
