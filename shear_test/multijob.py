...
simulation_time = round(simulation_data.timestep*simulation_data.prod_nloops*simulation_data.prod_isteps, 4) #total simulation time according to the simulation script in [ps]
...
start_command = 'sbatch jobscript_epp.sh 0'
continue_command = 'sbatch jobscript_epp.sh 1'
